        ...
        <div>
            ...
            <div id="touristSection">
                <div id="henryford" className="touristCard">
                    <a href="https://www.thehenryford.org/" className="touristTitle"><h2 className="titleH2">The Henry Ford Museum</h2></a>
                ...
                <div id="hitsville" className="touristCard">
                    <a href="https://www.motownmuseum.org/" className="touristTitle"><h2 className="titleH2">The Motown Museum</h2></a>
                ...
                <div id="hitsville" className="touristCard">
                    <a href="https://www.dia.org/" className="touristTitle"><h2 className="titleH2">The Detroit Institute of Art</h2></a>
